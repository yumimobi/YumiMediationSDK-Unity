...
[下载YumiMediationSDK Unity插件](https://github.com/yumimobi/YumiMediationSDK-Unity/releases/download/4.6.1/YumiMediationSDKPlugin.unitypackage)
...
```xml
    <iosPods>
        <iosPod name="YumiMediationSDK" version="4.6.2" minTargetSdk="9.0">
        </iosPod>
        <!-- adapters -->
        <iosPod name="YumiMediationAdapters/AdColony" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/AdMob" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Baidu" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Chartboost" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Domob" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Facebook" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/GDT" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/InMobi" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/IronSource" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Unity" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Vungle" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/Mintegral" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/OneWay" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/AtmosplayAds" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/TapjoySDK" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/InneractiveAdSDK" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapters/PubNative" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapterBytedance" version="4.6.2">
        </iosPod>
        <iosPod name="YumiMediationAdapterAppLovin" version="4.6.2">
        </iosPod>
        <!-- debugCenter -->
        <iosPod name="YumiMediationDebugCenter-iOS" version="4.6.2">
        </iosPod>
    </iosPods>
```

比如删除 `AdMob` ，直接删除 ` <iosPod name="YumiMediationAdapters/AdMob" version="4.6.2"></iosPod>`  即可。
...
```xml
<androidPackages>
  <androidPackage spec="com.yumimobi.ads:mediation:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:adcolony:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:applovin:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:atmosplay:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:pubnative:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:baidu:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:bytedance:4.6.1"/>
  <androidPackage spec="com.yumimobi.ads.mediation:chartboost:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:facebook:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:gdt:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:inneractive:4.6.1"/>
  <androidPackage spec="com.yumimobi.ads.mediation:oneway:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:ironsource:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:ksyun:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:tapjoy:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:unity:4.6.1" />
  ...
  <androidPackage spec="com.yumimobi.ads.mediation:admob:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:inmobi:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:vungle:4.6.1" />
  <androidPackage spec="com.yumimobi.ads.mediation:mintegral:4.6.1" />
...
比如删除 `admob`，直接删除 `<androidPackage spec="com.yumimobi.ads.mediation:admob:4.6.1" />` 即可。
