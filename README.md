...
[下载YumiMediationSDK Unity插件](https://github.com/yumimobi/YumiMediationSDK-Unity/releases/download/4.6.0/YumiMediationSDKPlugin.unitypackage)
...
比如删除 `AdMob` ，直接删除 ` <iosPod name="YumiMediationAdapters/AdMob" version="4.6.0"></iosPod>`  即可。
