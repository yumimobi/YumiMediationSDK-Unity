...
namespace Assets.ZplayMediationSDK.Scripts.SettingManager
{
    public class MediationManagerSetting : ScriptableObject
    {

        private const string settingsAssetName = "MediationManagerSetting";
        private const string settingsPath = "ZplayMediationSDK/Resources";
            ...
            get
            {
                if (instance == null)
                {
                    ...
                    if (instance == null)
                    {
                        ...
                        {
                            UnityEditor.AssetDatabase.CreateFolder("Assets/ZplayMediationSDK", "Resources");
                        }
...
#if UNITY_EDITOR
        [UnityEditor.MenuItem("Window/Zplay/Mediation/Edit Settings")]
        public static void ZplayPromoteHTSetting()
        {
            UnityEditor.Selection.activeObject = Instance;
            if (GameObject.Find("ZplayMediationAdManager"))
            {
            ...
            else
            {
                ...
                gameObject.name = "ZplayMediationAdManager";
                gameObject.AddComponent<ZplayMediationAdManager>();
            }
