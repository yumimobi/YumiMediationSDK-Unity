...
[下载YumiMediationSDK Unity插件](https://adsdk.yumimobi.com/Unity/3.6.1/YumiMediationSDKPlugin_v3.6.1.unitypackage)
...
比如删除 `AdMob` ，直接删除 ` <iosPod name="YumiMediationAdapters/AdMob" version="3.6.1"></iosPod>`  即可。
